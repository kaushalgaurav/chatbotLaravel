...
return [
  ...
  "Jobs" => "Trabajos",
  "Job_List" => "Lista de trabajo",
  "Job_Grid" => "Cuadrícula de trabajo",
  "Apply_Job" => "Aplicar al trabajo",
  "Job_Details" => "Detalles del trabajo",
  "Jobs_Categories" => "Categorías de trabajos",
  "Candidate" => "Candidato",
  "List" => "Lista",
