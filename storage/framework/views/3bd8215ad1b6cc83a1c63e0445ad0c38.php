                                            ...
                                            <div class="p-2 mt-4">
                                                ...
                                                <div class="mt-4">
                                                    <form class="d-inline" method="POST"
                                                        action="<?php echo e(route('verification.resend')); ?>">
                                                        <?php echo csrf_field(); ?>
                                                        <button type="submit"
                                                            class="btn btn-success"><?php echo e(__('Resend')); ?></button>
                                                    </form>
                                                </div>

                                                <div class="mt-3 text-center">
                                                <p>Don't want to verify ? <a href="<?php echo e(url('login')); ?>"
...
<?php echo $__env->make('layouts.master-without-nav', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\chatbotLaravel\resources\views\auth\verify.blade.php ENDPATH**/ ?>